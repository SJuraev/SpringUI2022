...
public class Transaction
{
    ...
    private static  final String BASE_QUERY = "SELECT T1.description As transactionDescription, T1.amount AS transactionAmount,\n" +
            ...
            "T2.category AS transactionCategory, T2.name AS transactionName, T3.name AS transactionStateName\n" +
    ...
    public static Transaction getById(int id){
        ...
        ResultSet resultSet = DBUtilsV2.query(query, id);
        List<Transaction> transactionList = DBUtilsV2.convertResultSetToBeans(resultSet, Transaction.class);
    ...
    public static List<Transaction> getByCategory(String category) {
        ...
        ResultSet resultSet = DBUtilsV2.query(query, category);
        return DBUtilsV2.convertResultSetToBeans(resultSet, Transaction.class);
    }

    public static void main(String[] args) {
       Transaction.getByCategory("DEBIT").forEach(System.out::println);
    }
